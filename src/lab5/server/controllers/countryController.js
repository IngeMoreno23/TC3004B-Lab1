...
exports.createCountry = async (req, res) => {
    ...
    try {
        ...
        res.status(201).json({ id: result.insertId, name, capital, currency });
    } catch (error) {
...
exports.updateCountry = async (req, res) => {
    ...
    try {
        ...
        const [checkRows] = await pool.query('SELECT * FROM country WHERE id = ?', [countryId]);
        ...
        res.json({ id: countryId, name, capital, currency });
    } catch (error) {
